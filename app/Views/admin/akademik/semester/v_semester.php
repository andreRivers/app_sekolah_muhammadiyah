                                        ...
                                        <div class="btn-group">
                                            ...
                                            <div class="dropdown-menu">
                                                <a href="#" class="dropdown-item" data-toggle="modal"
                                                    data-target="#modalEdit<?= $row['id_semester']; ?>">Edit</a>
...
<div class="modal fade" id="modalTambah" tabindex="-1" role="dialog">
    <div class="modal-dialog" role="document">
        <form action="<?= base_url('admin_semester/store') ?>" enctype="multipart/form-data" autocomplete="off"
            method="post">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        ...
                        <select id="tahun_ajaran_id" name="tahun_ajaran_id" class="form-control selectx" required>
                            <option selected disabled value="">Pilih</option>
                            <?php foreach ($ajaran as $row6) : ?>
                                <option value="<?= $row6['id_tahun_ajaran']; ?>">
                                    <?= $row6['tahun_ajaran']; ?> </option>
                            <?php endforeach ?>
                    </div>
...
<?php foreach ($v as $row) : ?>
    <div class="modal fade" id="modalEdit<?= $row['id_semester']; ?>" tabindex="-1" role="dialog">
        <div class="modal-dialog" role="document">
            <form action="<?= base_url('admin_semester/edit/' . $row['id_semester']) ?>" method="post">
                <div class="modal-content">
                    <div class="modal-header">
                    ...
                    <div class="modal-body">
                        <div class="form-group">
                            ...
                            <select id="semester" name="semester" class="form-control" required>
                                ...
                                <option value="Ganjil" <?= ($row['semester'] == 'Ganjil') ? 'selected' : '' ?>>Ganjil
                                </option>
                                <option value="Genap" <?= ($row['semester'] == 'Genap') ? 'selected' : '' ?>>Genap
                                </option>
                            </select>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <select id="tahun_ajaran_id" name="tahun_ajaran_id" class="form-control selectx" required>
                                ...
                                <?php foreach ($ajaran as $row6) : ?>
                                    <option value="<?= $row6['id_tahun_ajaran']; ?>"
                                        <?= ($row6['id_tahun_ajaran'] == $row['tahun_ajaran_id']) ? 'selected' : '' ?>>
                                        <?= $row6['tahun_ajaran']; ?>
                                    </option>
                                <?php endforeach ?>
                            </select>
