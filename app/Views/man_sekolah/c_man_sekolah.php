                            ...
                            <table class="table table-bordered">
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td><input class="form-control" type="text" id="kode_sekolah" name="kode_sekolah" value="<?= old('kode_sekolah'); ?>" required> </td>
                                    </tr>
                                    <tr>
                                        <td>NAMA SEKOLAH <span style="color:red;">*</span> </td>
                                        <td><input class="form-control" type="text" id="sekolah" name="sekolah" value="<?= old('nama_sekolah'); ?>" required> </td>
                                    </tr>

                                    <tr>
                                        <td>NO. HANDPHONE <span style="color:red;">*</span> </td>
                                        <td><input class="form-control" type="number" id="telp_sekolah" name="telp_sekolah" value="<?= old('telp_sekolah'); ?>" required> </td>
                                    </tr>
