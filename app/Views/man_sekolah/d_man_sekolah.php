            ...
            <div class="row mb-2">
                ...
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        ...
                        <li class="breadcrumb-item"><a href="#">Detail Sekolah</a></li>
                    </ol>
                </div>
            </div>
        </div><!-- /.container-fluid -->
