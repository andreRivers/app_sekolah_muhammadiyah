...
class Model_admin_pegawai extends Model
{
    ...
    protected $allowedFields = ['person_kode', 'jk', 'tempat_lahir', 'tgl_lahir', 'pendidikan_terakhir', 'bentuk_pendidik_id', 'sts_kepegawaian', 'alamat_rumah', 'no_hp_pegawai', 'tgl_masuk', 'tgl_keluar', 'jabatan_id'];
    ...
    public function getAll()
    {
        ...
        $builder->select('sm_pegawai.*, sm_users.*');
